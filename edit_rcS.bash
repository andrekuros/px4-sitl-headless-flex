...
sed -i "s/mavlink start \-x \-u \$udp_gcs_port_local -r 4000000 -f/mavlink start -x -u ${4} -r 4000000 -f ${GCS_PARAM}/" ${CONFIG_MAV}
sed -i "s/mavlink start -x -u \$udp_offboard_port_local -r 4000000 -f -m onboard -o \$udp_offboard_port_remote/mavlink start -x -u $5 -r 4000000 -f -m onboard -o \$udp_offboard_port_remote ${API_PARAM}/" ${CONFIG_MAV}
